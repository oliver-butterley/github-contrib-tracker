...
Generated: 2026-05-13  |  Data since: 2025-07-01
...
PRs: **9 opened** · 4 merged · 1 closed  |  Issues: **3 opened** · 0 closed
...
- [#1019 fix: Correctly flag used and unused variables](https://github.com/AeneasVerif/aeneas/pull/1019) — mpenciak — open
- [#1009 WIP: emit a manifest.json at translation](https://github.com/AeneasVerif/aeneas/pull/1009) — oliver-butterley — open
- [#981 Add release tag workflow for Lean updates.](https://github.com/AeneasVerif/aeneas/pull/981) — oliver-butterley — open
- [#963 fix: `do` elab regressions](https://github.com/AeneasVerif/aeneas/pull/963) — mpenciak — open
