...
Generated: 2026-08-21  |  Data since: 2025-07-01
...
|------|----------:|----------:|-------------:|-------------:|
| AeneasVerif/aeneas | 14 | 3 | 9 | 0 |
| AeneasVerif/charon | 1 | 0 | 2 | 1 |
...
PRs: **14 opened** · 3 merged · 0 closed  |  Issues: **9 opened** · 0 closed
...
- [#1254 Fix a bug with the namespacing of external items for the emit-json feature](https://github.com/AeneasVerif/aeneas/pull/1254) — oliver-butterley — open
...
- [#1248 Bug: `translation.json` `lean_name` for opaque functions carries the crate namespace prefix, but the emitted declaration in `FunsExternal_Template.lean` does not](https://github.com/AeneasVerif/aeneas/issues/1248) — astefano — open
...
PRs: **1 opened** · 0 merged · 0 closed  |  Issues: **2 opened** · 1 closed

**Pull requests:**

- [#1349 feat: generalize pre/postcondition attributes to associated functions](https://github.com/AeneasVerif/charon/pull/1349) — mkovaxx — open

**Issues:**

- [#1348 Feature request: generalize pre/postcondition attributes](https://github.com/AeneasVerif/charon/issues/1348) — mkovaxx — open
