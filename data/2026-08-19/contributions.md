...
Generated: 2026-08-19  |  Data since: 2025-07-01
...
|------|----------:|----------:|-------------:|-------------:|
| AeneasVerif/aeneas | 14 | 2 | 9 | 0 |
| AeneasVerif/charon | 1 | 0 | 2 | 0 |
| verus-lang/verus | 17 | 15 | 9 | 2 |
...
PRs: **14 opened** · 2 merged · 0 closed  |  Issues: **9 opened** · 0 closed
...
- [#1263 Fix sort order in tests/lean/script.sh](https://github.com/AeneasVerif/aeneas/pull/1263) — oliver-butterley — open
...
PRs: **1 opened** · 0 merged · 0 closed  |  Issues: **2 opened** · 0 closed
...
- [#1346 Bug: `iter_crate_with_span`/`map_crate_with_span` doesn't track the item environment for type decls](https://github.com/AeneasVerif/charon/issues/1346) — mpenciak — open

### verus-lang/verus

PRs: **17 opened** · 15 merged · 0 closed  |  Issues: **9 opened** · 2 closed
...
- [#2828 [cargo-verus] feat: partial verification needs `focus` mode](https://github.com/verus-lang/verus/pull/2828) — mkovaxx — open
- [#2793 [bump_crate_versions] refactor: ensure absolute paths](https://github.com/verus-lang/verus/pull/2793) — mkovaxx — open

**Issues:**

- [#2827 [cargo-verus] feat: restrict `--verify-module` & co. to `focus` mode](https://github.com/verus-lang/verus/issues/2827) — mkovaxx — open
...
PRs: **20 opened** · 12 merged · 4 closed  |  Issues: **12 opened** · 5 closed
...
- [#1169 Avoid reserved keywords being used as a bare name](https://github.com/AeneasVerif/aeneas/pull/1169) — oliver-butterley — open
...
- [#1163 Lean keywords used as function names aren't escaped](https://github.com/AeneasVerif/aeneas/issues/1163) — oliver-butterley — open
