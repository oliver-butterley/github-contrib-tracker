...
Generated: 2026-07-19  |  Data since: 2025-07-01
...
|------|----------:|----------:|-------------:|-------------:|
| AeneasVerif/aeneas | 3 | 0 | 5 | 0 |
| verus-lang/verus | 5 | 4 | 1 | 0 |
...
PRs: **3 opened** · 0 merged · 0 closed  |  Issues: **5 opened** · 0 closed
...
- [#1195 Aeneas has hard crash related to certain GATs](https://github.com/AeneasVerif/aeneas/issues/1195) — oliver-butterley — open
- [#1193 Trait method of a reference-parameterized trait passed to `.map` is "Unimplemented"](https://github.com/AeneasVerif/aeneas/issues/1193) — oliver-butterley — open
- [#1192 Second loop zipping two mutable slice iterators](https://github.com/AeneasVerif/aeneas/issues/1192) — oliver-butterley — open

### verus-lang/verus

PRs: **5 opened** · 4 merged · 0 closed  |  Issues: **1 opened** · 0 closed
...
- [#2668 [toolchains] CI: create toolchain manifest in the Rolling Release flow](https://github.com/verus-lang/verus/pull/2668) — mkovaxx — open
