...
Generated: 2026-08-18  |  Data since: 2025-07-01
...
|------|----------:|----------:|-------------:|-------------:|
| AeneasVerif/aeneas | 12 | 2 | 9 | 0 |
| AeneasVerif/charon | 1 | 0 | 2 | 0 |
| verus-lang/verus | 15 | 12 | 8 | 1 |
...
PRs: **12 opened** · 2 merged · 0 closed  |  Issues: **9 opened** · 0 closed
...
PRs: **15 opened** · 12 merged · 0 closed  |  Issues: **8 opened** · 1 closed
...
- [#2807 docs: update `BUILD.md` with info on the Cargo-only build](https://github.com/verus-lang/verus/pull/2807) — mkovaxx — open
- [#2796 [CI] feat: `release.yml` performs a clean build](https://github.com/verus-lang/verus/pull/2796) — mkovaxx — open
...
- [#2795 [CI] feat: the Release flow performs a clean build](https://github.com/verus-lang/verus/issues/2795) — mkovaxx — open
